    ...
    <div className="outerContainer">
      <div className="innerContainer">
        ...
        <div className="dropSelect">
          <div className="innerImg" style={{background: `url(${img})`}}>
            {/* <img
              src={img}
